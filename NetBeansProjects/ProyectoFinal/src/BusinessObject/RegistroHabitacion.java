...
//    }
//
//    public String agregar(int idHabitacion, int idCliente, int idEmpleado, String fechaIngreso) {
//        String mensaje = "";
//
//        RegistroHabitacionDTO t = new RegistroHabitacionDTO(idHabitacion, idCliente, idEmpleado, fechaIngreso);
//        if (registroHabitacionDAO.agregar(t)) {
...
//    }
//
//    public String checkOut(int idRegistro, String fechaSalida) {
//        String mensaje = "";
//        registroHabitacionDTO = new RegistroHabitacionDTO(idRegistro, fechaSalida);
//        if (registroHabitacionDAO.actualizar(registroHabitacionDTO)) {
...
//        registroHabitacionDTO.setIdHabitacion(idHabitacion);
...
//        registroHabitacionDTO = new RegistroHabitacionDTO();
//        registroHabitacionDTO.setIdCliente(idCliente);
...
//        registroHabitacionDTO = new RegistroHabitacionDTO();
//        registroHabitacionDTO.setIdEmpleado(idEmpleado);
...
//    }
//
//    public List<RegistroHabitacionDTO> buscarFechaIngreso(String fechaIngreso) {
//        registroHabitacionDTO = new RegistroHabitacionDTO();
...
//    }
//
//    public List<RegistroHabitacionDTO> buscarFechaSalida(String fechaSalida) {
//        registroHabitacionDTO = new RegistroHabitacionDTO();
...
//        if (registroHabitacionDAO.listar() != null) {
//            return registroHabitacionDAO.listar();
//        } else {
//            return null;
//        }
//    }
