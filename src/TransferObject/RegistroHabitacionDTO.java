...
public class RegistroHabitacionDTO {
    ...
    public RegistroHabitacionDTO(int idRegistroHabitacion, Date fechaSalida) {
    ...
    public RegistroHabitacionDTO(int idRegistroHabitacion) {
        this.idRegistroHabitacion = idRegistroHabitacion;
    }

    public RegistroHabitacionDTO(Date fechaIngreso) {
        this.fechaIngreso = fechaIngreso;
    }

    public RegistroHabitacionDTO(int ClienteID, int EmpleadoID, int HabitacionID, Date fechaIngreso) {
